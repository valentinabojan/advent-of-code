...
fun main(args: Array<String>) {
    File("src/main/resources/day_9/puzzle_1.txt").forEachLine { println(Puzzle().computeSumOfNestedBlocks(it)) }
    File("src/main/resources/day_9/puzzle_2.txt").forEachLine { println(Puzzle().computeGarbageCharacters(it)) }
}